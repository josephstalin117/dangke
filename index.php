<?php
session_start();
$userNum = isset($_SESSION["userID"]) ? $_SESSION["userID"] : '';
if ($userNum != NULL) {
        ...
        <div class="index_container">
            <div class="login_container">
                ...
                <form id="login" name="login" method="post" action="login.php">
                    <div>
                        <h3 style="float:left; line-height:36px; color:#333; font-weight:lighter; font-family:Microsoft Yahei, Helvetica, sans-serif;">学号:</h3>
